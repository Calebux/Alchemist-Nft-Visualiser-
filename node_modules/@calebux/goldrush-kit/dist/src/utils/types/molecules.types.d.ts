...
import { type Chain, type PoolWithTimeseries, type UniswapLikeEcosystemCharts, type TokenV2VolumeWithChartData, type ExchangeTransaction, type Transaction } from "@covalenthq/client-sdk";
...
export interface DecodedTransactionProps {
    chain_name: Chain;
    tx_hash: string;
    setMetadata?: React.Dispatch<React.SetStateAction<Option<DecodedTransactionMetadata>>>;
}
